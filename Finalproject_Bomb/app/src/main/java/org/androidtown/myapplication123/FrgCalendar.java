...
import org.androidtown.myapplication123.widget.CalendarItemView;
import org.androidtown.myapplication123.widget.CalendarView;
...
public class FrgCalendar extends Fragment {
    ...
    protected void initView() {
        ...
        for (int i = 0; i < maxDateOfMonth + 7; i++) {
            ...
            //   Toast.makeText(getContext(),child.getWorkday()+"",Toast.LENGTH_SHORT).show();
            // 이벤트가 있는 날 밑줄 표시, 20이면 14일 표시, 10이면 4일 표시. 6일 차이남
            if (i == (child.getWorkday())) {
